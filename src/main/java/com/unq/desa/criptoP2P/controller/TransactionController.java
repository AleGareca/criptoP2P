...
public class TransactionController {
    ...
    public void tranfer(@Valid @RequestBody RequestTransferDto requestTransferDto,Authentication authentication, Errors errors) throws Exception {
    ...
    public ResponseEntity<Object> confirm(@NotNull @RequestPart("transaction_id") Integer transaction_id, Authentication authentication, Errors errors) throws Exception {
        this.transactionService.operationConfirm(transaction_id,authentication.getName());
    ...
    public void cancelled(@NotNull @RequestPart("transaction_id") Integer transaction_id,Authentication authentication, Errors errors) throws Exception {
        this.transactionService.operationCancelled(transaction_id,authentication.getName());
    }
